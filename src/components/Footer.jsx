  ...
  return (
    ...
    overflow-hidden' id='Footer'>
      ...
      items-start'>
        <div className='w-full md:w-1/3 mb-8 md:mb-0'>
            ...
            <p className='text-gray-400 mt-4'>Lorem ipsum dolor sit amet, consectetur adipisicing elit. 
                Ea nulla maxime, aspernatur ab error enim veniam at debitis? Debitis suscipit deserunt assumenda exercitationem nobis. 
                Quasi porro pariatur quo labore fugiat.</p>
        </div>
      ...
      <div className='border-t border-gray-700 py-4 mt-10 text-center text-gray-500'>
        Copyright 2024 @ Tinycoder. All Rights Reserved.
      </div>
    </div>
  )
}
